...
\begin{document}
	...
	\section{MapNoReduce Architecture}
    	...
    	\subsection{Cluster Resource Management}
            ...
            the server node were it is located. Subsequent Job Trackers that arrive at the system, ask for an equal share to process their jobs,
            ...
            Finally, if there are not enough workers available in all server nodes to complete the share a Job Tracker requires, that Job Tracker is put
