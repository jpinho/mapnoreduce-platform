...
namespace SharedTypes
{
    ...
    public interface IWorker
    {
		...
		/// <summary>
		/// Function responsible to executes the task received:
		/// Asks for the data needed to the client, loads the map function and applies it. 
		...
		/// <summary>
		/// Simulates a fault of this worker.
		/// Changes the status to frozen and freezes all the requests using
		/// ManualResetEvents.
		/// </summary>
		...
		/// <summary>
		/// Simulates recovery from a fault of this worker.
		/// Changes the status to available and processes all the frozen requests
		/// setting the ManualResetEvents.
		/// </summary>
		/// <see><cref>https://msdn.microsoft.com/en-us/library/system.threading.manualresetevent</cref></see>
        void UnFreeze();
		...
		/// </summary>
		/// <param name="priority"> Priority used to decide which replica would 
		/// rise in case of failure.</param>
